...
if(preg_match("/dev./i",$_SERVER['HTTP_HOST'])){
	$DOMAIN = "http://{$_SERVER['HTTP_HOST']}/campusrace/";
	$PUBLIC_HTML = "";
}else{
	$DOMAIN = "http://{$_SERVER['HTTP_HOST']}/campusrace/";
...
$CONFIG['BASE_DOMAIN_PATH'] = "http://{$_SERVER['HTTP_HOST']}/campusrace/public_html/"; //localhost
...
$CONFIG['LOCAL_PUBLIC_ASSET'] = $_SERVER['DOCUMENT_ROOT']."/campusrace/public_html/public_assets/";
