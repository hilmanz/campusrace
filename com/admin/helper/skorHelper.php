	...
	function skor($start=null,$limit=10){
		...
		*/
		...
		$sql = "SELECT COUNT(*) as total 
				FROM ss_tebakan_skor as a inner join ss_member as b inner join ss_chapter as c on a.member_id=b.id
	            where a.week_id=(select week_id from ss_pertandingan_tebakskor where n_status=1) "; 
		...
		$sql = "select a.*, b.*,(if(a.skor1=d.skor1 and a.skor2=d.skor2,1,0) + if(a.skor3=d.skor3 and a.skor4=d.skor4,1,0) + if(a.skor5=d.skor5 and a.skor6=d.skor6,1,0)) as total_skor,
b.name as membername		
from ss_tebakan_skor as a
inner join ss_member as b
inner join ss_pertandingan_tebakskor as d
on a.member_id=b.id and a.week_id = d.week_id
where d.n_status=1
