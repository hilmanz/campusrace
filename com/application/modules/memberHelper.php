...
class memberHelper {
	...
	global $CONFIG;
		$pertandingan1 = $data['pertandingan1'];
		$pertandingan3 = $data['pertandingan3'];
		$pertandingan5 = $data['pertandingan5'];
		...
		$sql = "
				INSERT {$this->config['DATABASE'][0]['DATABASE']}.ss_tebak_skor_detail SET
				`pertandingan1`= {$pertandingan1},
				`id_member`='{$member}',
				`skor1`='{$skor1}',
				`skor2`='{$skor2}',
				`created`=NOW()
